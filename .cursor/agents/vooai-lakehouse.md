...
Bronze bruto, Silver limpo, Gold analítico. Export `scripts/export_gold.py` para o produto local. Não acoplar o front ao cluster Free em cada request no MVP. Sem Unity/OCI corporativo de outros projetos.
